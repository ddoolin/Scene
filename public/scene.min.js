window.Scene.HomeController = function() {
    ...
    }, this.renderSpot = function(a) {
        var a = a.spot, b = "<div class='spot'><a class='spot-address' href='#' data-lat='" + a.latitude + "' data-lng='" + a.longitude + "'>" + a.address + "</a></div>";
        $("#sidebar .spots").prepend(b);
