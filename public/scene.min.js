window.Scene = {}, !function(a) {
    ...
    b.prototype = {
        ...
        enter: function(b) {
            ...
            c.hoverState = "in", this.timeout = setTimeout(function() {
...
}(window.jQuery), window.Scene.HomeController = function() {}, function() {
    var a, b = window.Scene;
    new b.HomeController(), a = {}, function() {
        Modernizr.geolocation && (pos = navigator.geolocation.getCurrentPosition(), console.log(pos));
    }();
}(jQuery);