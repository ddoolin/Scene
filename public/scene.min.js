window.Scene.HomeController = function() {
    ...
    this.createMap = function(b) {
        ...
        c.image && (d += "<img src='" + c.image + "' class='photo' />"), d += "<a class='first-heading' href='/events/" + c._id + "''>" + c.name + "</a><div class='body-content'>" + "<p class='time'>" + a.formatDate(new Date(c.duration.starttime)) + " @ " + a.formatTime(new Date(c.duration.starttime)) + "</p>" + "<p class='description'>" + c.description + "</p>" + "</div>" + "</div>", 
