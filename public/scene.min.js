window.Scene.HomeController = function() {
    ...
    this.createMap = function(b) {
        ...
        var d = "<div class='content'><img src='" + c.image + "' class='photo' />" + "<a class='first-heading' href='/events/" + c._id + "''>" + c.name + "</a><div class='body-content'>" + "<p class='time'>" + a.formatDate(new Date(c.duration.starttime)) + " @ " + a.formatTime(new Date(c.duration.starttime)) + "</p>" + "<p class='description'>" + c.description + "</p>" + "</div>" + "</div>";
